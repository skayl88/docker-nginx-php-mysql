...
trait Kama_Thumbnail_Admin_Part {
	...
	function admin_options(){
		...
		add_settings_field( 'kt_options_field',
			...
			<p><a class="button" target="_blank" href="'. add_query_arg('kt_clear', 'delete_meta') .'" onclick="return confirm(\''. __('Are You Sure?','kama-thumbnail') .'\')">'. __('Remove Releted Custom Fields','kama-thumbnail') .'</a></p>
			
			<p><a class="button" target="_blank" href="'. add_query_arg('kt_clear', 'clear_all_data') .'" onclick="return confirm(\''. __('Are You Sure?','kama-thumbnail') .'\')">'. __('Remove all data','kama-thumbnail') .'</a></p>
			',
...
trait Kama_Thumbnail_Cear_Cache {
