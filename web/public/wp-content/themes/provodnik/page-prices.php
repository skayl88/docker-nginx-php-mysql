...
<div class="b1 b1-3">
    <div class="container">
        <div class="price-box-wide">
            ...
            <div class="inner0">
                ...
                <p class="salep">*Акция действует до 30.09.2021 для новых пользователей, только при покупке лицензии на
                    1 год.<br> Цена включает в себя все модули и последующие обновления.</p>
                <div class="inner dop-border" id="dop-border">
                    <div class="c1 cena">
                        <div id="fransh" class='hiden'>
                            <div class="ttl">Свяжитесь с нами для уточнения цены </div>
                            <div class="btn-box"><a class="btn3" href="https://ollaberkana.ru/kontakty/">Связаться</a>
                            </div>
                        </div>
                ...
                <div id="range">
                    <input type="range" class="range" id="range2" value="4" min="1" max="6"
                        onmousemove="rangeSlider(this.value)" onchange="rangeSlider(this.value)">

                    <div class="point">
                        <p>1 месяц</p>
                    </div>
                    <div class="point month3" id='month3'>
                        <p>3 месяца</p>
                    </div>
                    <div class="point month6" id='month6'>
                        <p>6 месяцев</p>
                    </div>
                    <div class="point month12 sale" id="month12">
                        <p class='year'>1 год</p>
                    </div>
                    <div class="point inf" id="inf">
                        <p>Купить навсегда</p>
                    </div>
                    <div class="point fransh" id="fransh">
                        <p>Для фрашиз</p>
                    </div>
                </div>
            </div>
    ...
    <div class="items5-list v2 new">
        <a class="c1" href="<?php echo get_page_link(184); ?>" style="text-decoration: none;">
            <div class="box">
                ...
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/chatbot.svg" /></span>
                </div>
                <p>Чат боты</p>
            </div>
        </a>
        <a class="c1" href="<?php echo get_page_link(188); ?>" style="text-decoration: none;">
            <div class="box">
                ...
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/calendar.svg" /></span>
                </div>
        ...
        <a class="c1" href="<?php echo get_page_link(186); ?>" style="text-decoration: none;">
            <div class="box">
                ...
                <div class="ico"><span><img
                            src="<?php echo get_template_directory_uri(); ?>/img/whatsapp_icon.svg" /></span></div>
                <p> WhatsApp</p>
            </div>
        </a>
    ...
    <div class="items5-list v2">
        <a class="c1" href="<?php echo get_page_link(30); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/customer.svg"
                            alt="" /></span></div>
                <p>Учет клиентов</p>
            </div>
        </a>
        ...
        <a class="c1" href="<?php echo get_page_link(35); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/checklist.svg"
                            alt="" /></span></div>
        ...
        <a class="c1" href="<?php echo get_page_link(37); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/target.svg"
                            alt="" /></span></div>
                <p>Маркетинг</p>
            </div>
        </a>
        <a class="c1" href="<?php echo get_page_link(39); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/support.svg"
                            alt="" /></span></div>
        ...
        <a class="c1" href="<?php echo get_page_link(41); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/send-mail.svg"
                            alt="" /></span></div>
                <p>Рассылки</p>
            </div>
        </a>
        <a class="c1" href="<?php echo get_page_link(43); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/income.svg"
                            alt="" /></span></div>
        ...
        <a class="c1" href="<?php echo get_page_link(45); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/pos.svg"
                            alt="" /></span></div>
                <p>Кассы</p>
            </div>
        </a>
        <a class="c1" href="<?php echo get_page_link(47); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/review.svg"
                            alt="" /></span></div>
        ...
        <a class="c1" href="<?php echo get_page_link(49); ?>" style="text-decoration: none;">
            <div class="box">
                <div class="ico"><span><img src="<?php echo get_template_directory_uri(); ?>/img/gift-card.svg"
                            alt="" /></span></div>
